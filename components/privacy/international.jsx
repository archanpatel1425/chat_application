...
const InternationalDataTransfers = ({ block, dataBinding }) => {
  const { title, qusetion, description1, description2, description3 } = block;
  return (
    <div>
      <div className='max-w-[90%] xl:max-w-[1280px] mx-auto my-0 px-0 em:px-4' >
        <div className='mt-[50px] md:mt-[100px]' data-cms-bind={dataBinding}>
          <h5 className='text-[26px] md:text-[34px] leading-[30px] text-[#3D405B] font-DM font-bold pt-[20px] pb-[20px] md:pb-[40px]'>5. {title}</h5>
