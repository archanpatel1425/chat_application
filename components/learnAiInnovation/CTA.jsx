            ...
            <div className='px-[15px] em:px-[30px] md:px-[77px] py-[30px] md:py-[42px] bg-[#9370E4] rounded-[15px] block lg:flex items-center justify-between font-DM'>
                   <div className='w-[100%] lg:w-[70%] text-center lg:text-left'>
                    ...
                    <div className='font-DM ml-auto block md:flex text-center justify-center mt-[30px] lg:mt-0'>
                        <button  className='flex items-center text-[16px] md:text-[18px] text-black bg-[#FFFFFF] rounded-[3px] mt-[20px] md:mt-0 mx-auto md:mx-0 '><Link href={btn_link} className='flex items-center bg-[100%] py-[10px] md:py-[15px] pr-[30px] md:pr-[50px] pl-[30px] md:pl-[40px] transition duration-300  bg-repeat font-bold leading-[27px] text-[#9370E4]  hover:shadow-btn ease-in-out'>{btn_text}</Link>     
                        </button>
                    </div>   
            </div>
            </div>
